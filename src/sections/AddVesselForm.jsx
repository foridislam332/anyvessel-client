...
const AddVesselForm = ({ myVesselData, refetch, setAddNewVessel }) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-center gap-6 mt-20">
                ...
                <button onClick={() => setAddNewVessel(false)} disabled={myVesselData.length > 0 ? false : true}
                    type="button" className="cursor-pointer text-blue font-light bg-transparent py-[7px] rounded-[9px] border-2 border-blue hover:bg-blue hover:text-white hover:shadow-lg hover:shadow-blue/20 duration-300 w-48 grid place-items-center">
                    Cancel
                </button>
            </div>
        </form>
