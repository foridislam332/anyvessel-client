    ...
    <section>
      <div>
        ...
        <div className="relative">
          ...
          <label htmlFor="coverPhoto" className='bg-white rounded-full border border-black bg-lightDark/80 top-1 right-1 hover:bg-lightDark text-2xl p-[5px] z-20 cursor-pointer  duration-300 absolute '>
            ...
            />
            <p className="flex items-center gap-1"> <span className="text-sm">Upload Photo </span><BsCamera /></p>
        ...
        <div className="flex justify-between mr-3 mt-2">
          ...
          <div className='relative '>
            <div className=''>
              {
                profileUpdateLoading ?
                  ...
                  <h3 className="w-40 h-40 mx-auto flex items-center justify-center rounded-full hover:scale-105 border-2 border-red-700 text-2xl text-black animate-pulse -mt-24">Loading...</h3>
                  :
                  <div>
                    {
                      identityPhoto ?
            ...
            <label htmlFor="photo" className='bg-white rounded-full border border-black bg-lightDark/80 bottom-2 right-1 hover:bg-lightDark text-2xl p-[5px] z-20 cursor-pointer  duration-300 absolute '>
